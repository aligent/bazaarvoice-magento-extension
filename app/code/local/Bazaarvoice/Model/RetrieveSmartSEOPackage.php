 ...
 */
class Bazaarvoice_Model_RetrieveSmartSEOPackage extends Mage_Core_Model_Abstract {
    ...
    public function retrieveSmartSEOPackage() {
        ...
        if(Mage::getStoreConfig("bazaarvoice/SmartSEOFeed/EnableSmartSEO") === "1") {
            ...
            //Download the file
            if (!Bazaarvoice_Helper_Data::downloadFile($localFilePath, $gzLocalFilename, $remoteFile)) {
                ...
                if (!file_exists($localExtractsPath)) {
                    ...
                    Bazaarvoice_Helper_Data::sendNotificationEmail($subject, $msg);
                    Mage::log($msg);
                    die($msg);
                }
