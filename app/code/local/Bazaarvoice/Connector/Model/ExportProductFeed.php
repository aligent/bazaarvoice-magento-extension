...
class Bazaarvoice_Connector_Model_ExportProductFeed extends Mage_Core_Model_Abstract
{
    ...
    {
        // Log
        Mage::log('Start Bazaarvoice product feed generation', Zend_Log::INFO, Bazaarvoice_Connector_Helper_Data::LOG_FILE);
        ...
        // Log
        Mage::log('End Bazaarvoice product feed generation', Zend_Log::INFO, Bazaarvoice_Connector_Helper_Data::LOG_FILE);
    }
    ...
    {
        // Log
        Mage::log('Exporting product feed file for each website...', Zend_Log::INFO, Bazaarvoice_Connector_Helper_Data::LOG_FILE);
    ...
    {
        // Log
        Mage::log('Exporting product feed file for each store group...', Zend_Log::INFO, Bazaarvoice_Connector_Helper_Data::LOG_FILE);
    ...
    {
        // Log
        Mage::log('Exporting product feed file for each store / store view...', Zend_Log::INFO, Bazaarvoice_Connector_Helper_Data::LOG_FILE);
        // Iterate through all stores / groups in this instance
        // (Not the 'admin' store view, which represents admin panel)
    ...
    private function uploadFeed($productFeedFileName, Mage_Core_Model_Store $store)
    {
        ...
        if (!$upload) {
            Mage::log('    Bazaarvoice FTP upload failed! [filename = ' . $productFeedFileName . ']', Zend_Log::INFO, Bazaarvoice_Connector_Helper_Data::LOG_FILE);
        }
        else {
            Mage::log('    Bazaarvoice FTP upload success! [filename = ' . $productFeedFileName . ']', Zend_Log::INFO, Bazaarvoice_Connector_Helper_Data::LOG_FILE);
